...
[![GoDoc](https://godoc.org/github.com/giangnamnabka/btcwallet/walletdb?status.png)]
(http://godoc.org/github.com/giangnamnabka/btcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/giangnamnabka/btcwallet/walletdb

## Installation

```bash
$ go get github.com/giangnamnabka/btcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/giangnamnabka/btcwallet/walletdb#example-package--BasicUsage)  

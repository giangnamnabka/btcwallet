...
[![Build Status](https://travis-ci.org/giangnamnabka/btcwallet.png?branch=master)](https://travis-ci.org/giangnamnabka/btcwallet)
...
can be found [here](https://github.com/giangnamnabka/btcd).  An alternative
...
https://github.com/giangnamnabka/btcwallet/releases
...
```bash
$ cd $GOPATH/src/github.com/giangnamnabka/btcwallet
...
```bash
$ cp $GOPATH/src/github.com/giangnamnabka/btcd/sample-btcd.conf ~/.btcd/btcd.conf
$ cp $GOPATH/src/github.com/giangnamnabka/btcwallet/sample-btcwallet.conf ~/.btcwallet/btcwallet.conf
...
The [integrated github issue tracker](https://github.com/giangnamnabka/btcwallet/issues)
